...
object V2CommonConfigDefaultValues {
  ...
  val AwsCredentialsProviderProviderClassName =
    "com.github.j5ik2o.pekko.persistence.dynamodb.client.v2.AwsCredentialsProviderProvider"

  val MetricPublishersProviderClassName =
    "com.github.j5ik2o.pekko.persistence.dynamodb.client.v2.MetricPublishersProvider"
