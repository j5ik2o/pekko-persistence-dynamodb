...
import com.github.j5ik2o.pekko.persistence.dynamodb.config.client.{ CommonConfigKeys, V1CommonConfigKeys }
import net.ceedubs.ficus.Ficus._
import com.github.j5ik2o.pekko.persistence.dynamodb.utils.{ ClassCheckUtils, LoggingSupport }
...
object DynamoDBClientV1Config extends LoggingSupport {
  ...
  val RequestMetricCollectorProviderClassName =
    "com.github.j5ik2o.pekko.persistence.dynamodb.client.v1.RequestMetricCollectorProvider"

  val MonitoringListenerProviderClassName =
    "com.github.j5ik2o.pekko.persistence.dynamodb.client.v1.MonitoringListenerProvider"

  val RequestHandlersProviderClassName =
    "com.github.j5ik2o.pekko.persistence.dynamodb.client.v1.RequestHandlersProvider"

  val CsmConfigurationProviderProviderClassName =
    "com.github.j5ik2o.pekko.persistence.dynamodb.client.v1.CsmConfigurationProviderProvider"
