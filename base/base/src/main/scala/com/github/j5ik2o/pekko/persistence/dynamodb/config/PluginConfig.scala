...
object PluginConfig {
  ...
  val PlugInLifecycleHandlerFactoryClassName =
    "com.github.j5ik2o.pekko.persistence.dynamodb.utils.PlugInLifecycleHandlerFactory"
  val PlugInLifecycleHandlerClassName  = "com.github.j5ik2o.pekko.persistence.dynamodb.utils.PlugInLifecycleHandler"
  val V1AsyncClientFactoryClassName    = "com.github.j5ik2o.pekko.persistence.dynamodb.utils.V1AsyncClientFactory"
  val V1SyncClientFactoryClassName     = "com.github.j5ik2o.pekko.persistence.dynamodb.utils.V1SyncClientFactory"
  val V1DaxAsyncClientFactoryClassName = "com.github.j5ik2o.pekko.persistence.dynamodb.utils.V1DaxAsyncClientFactory"
  val V1DaxSyncClientFactoryClassName  = "com.github.j5ik2o.pekko.persistence.dynamodb.utils.V1DaxSyncClientFactory"
  val V2AsyncClientFactoryClassName    = "com.github.j5ik2o.pekko.persistence.dynamodb.utils.V2AsyncClientFactory"
  val V2SyncClientFactoryClassName     = "com.github.j5ik2o.pekko.persistence.dynamodb.utils.V2SyncClientFactory"
  val V2DaxAsyncClientFactoryClassName = "com.github.j5ik2o.pekko.persistence.dynamodb.utils.V2DaxAsyncClientFactory"
  val V2DaxSyncClientFactoryClassName  = "com.github.j5ik2o.pekko.persistence.dynamodb.utils.V2DaxSyncClientFactory"

  val JournalRowWriteDriverFactoryClassName =
    "com.github.j5ik2o.pekko.persistence.dynamodb.journal.JournalRowWriteDriverFactory"
}
