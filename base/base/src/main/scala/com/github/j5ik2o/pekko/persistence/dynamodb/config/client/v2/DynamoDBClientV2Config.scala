...
object DynamoDBClientV2Config extends LoggingSupport {
  ...
  val RetryPolicyProviderClassName = "com.github.j5ik2o.pekko.persistence.dynamodb.client.v2.RetryPolicyProvider"
  val ExecutionInterceptorsProviderClassName =
    "com.github.j5ik2o.pekko.persistence.dynamodb.client.v2.ExecutionInterceptorsProvider"
