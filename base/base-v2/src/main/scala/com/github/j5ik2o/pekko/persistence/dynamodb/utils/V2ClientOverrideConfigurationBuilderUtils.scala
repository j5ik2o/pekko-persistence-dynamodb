...
import com.github.j5ik2o.pekko.persistence.dynamodb.client.v2.{
...
object V2ClientOverrideConfigurationBuilderUtils {
  ...
  def setup(pluginContext: PluginContext): ClientOverrideConfiguration.Builder = {
    ...
    retryMode.foreach { v =>
      val r = v match {
        case com.github.j5ik2o.pekko.persistence.dynamodb.config.client.RetryMode.LEGACY =>
          RetryMode.LEGACY
        case com.github.j5ik2o.pekko.persistence.dynamodb.config.client.RetryMode.STANDARD =>
          RetryMode.STANDARD
        case com.github.j5ik2o.pekko.persistence.dynamodb.config.client.RetryMode.ADAPTIVE =>
          RetryMode.ADAPTIVE
      }
