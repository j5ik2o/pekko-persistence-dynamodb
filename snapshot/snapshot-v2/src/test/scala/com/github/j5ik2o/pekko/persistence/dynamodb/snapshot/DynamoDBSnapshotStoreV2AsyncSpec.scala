...
final class DynamoDBSnapshotStoreV2AsyncSpec
    extends SnapshotStoreSpec(
      ConfigFactory
        .parseString(
          s"""
           |j5ik2o.dynamo-db-journal.dynamo-db-client {
           |  endpoint = "http://${DynamoDBSnapshotStoreV2AsyncSpec.dynamoDBHost}:${DynamoDBSnapshotStoreV2AsyncSpec.dynamoDBPort}/"
           |}
           |
  ...
  override lazy val dynamoDBPort: Int = DynamoDBSnapshotStoreV2AsyncSpec.dynamoDBPort
