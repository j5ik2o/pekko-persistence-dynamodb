package com.github.j5ik2o.pekko.persistence.dynamodb.example.untyped.eventsourced
...
import com.github.j5ik2o.pekko.persistence.dynamodb.example.untyped.eventsourced.CounterProtocol.{
  GetValueReply,
  State,
  ValueAdded
}
