...
final class DynamoDBDurableStateStoreProvider(system: ExtendedActorSystem) extends DurableStateStoreProvider {
  ...
  private def createStore[A]
      : com.github.j5ik2o.pekko.persistence.dynamodb.state.scaladsl.ScalaDurableStateUpdateStore[A] = {
    val className = statePluginConfig.clientConfig.clientVersion match {
      case ClientVersion.V2 =>
        "com.github.j5ik2o.pekko.persistence.dynamodb.state.scaladsl.V2ScalaDurableStateUpdateStoreFactory"
      case ClientVersion.V2Dax =>
        "com.github.j5ik2o.pekko.persistence.dynamodb.state.scaladsl.V2DaxScalaDurableStateUpdateStoreFactory"
      case ClientVersion.V1 =>
        "com.github.j5ik2o.pekko.persistence.dynamodb.state.scaladsl.V1ScalaDurableStateUpdateStoreFactory"
      case ClientVersion.V1Dax =>
        "com.github.j5ik2o.pekko.persistence.dynamodb.state.scaladsl.V1DaxScalaDurableStateUpdateStoreFactory"
    }
