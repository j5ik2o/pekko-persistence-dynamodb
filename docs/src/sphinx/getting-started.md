...
libraryDependencies += Seq(
  "io.github.j5ik2o" %% s"pekko-persistence-dynamodb-journal-$awsClientVersion" % version,
  "io.github.j5ik2o" %% s"pekko-persistence-dynamodb-snapshot-$awsClientVersion" % version
)
```
